...
源地址 https://github.com/hetu-script/random_chinese_fantasy_names

## 新增

本地html直接浏览器启动, 无需联网, 无需环境配置即可启用

### 使用方法

    1. 下载项目到本地
    2. 到local文件夹下双击index.html, 使用浏览器打开
    3. 主要数据在local\data文件夹, 可随意修改, 修改后刷新index.html页面便生效
